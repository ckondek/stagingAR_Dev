...
public class ScreenshotObject
{
    ...
    private Material screenshotMaterial;

    public ScreenshotObject(CameraRenderEvent camera, Shader textureShader, GameObject timer, Material material)
    {
        cam = camera;
    ...
    private void SpawnTimer()
    {
        ...
        Vector3 pos = cam.transform.position + cam.transform.forward * 0.749f;
